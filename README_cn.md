...
|**apply26h2 = 0**|默认不集成 Windows 11 26H2 启用包补丁（KB5121794）。如需集成 26H2 补丁（25H2 ISO 集成后也会升级至 26H2）。请改成1。启用包同时受 SkipKB 控制|
|**SkipKB = 5054156,5121794**|逗号分隔的要排除集成的 KB 号。默认排除 25H2（KB5054156）和 26H2（KB5121794）启用包，保持 24H2 基线。清空后可配合 apply26h2 升级至 25H2/26H2|
